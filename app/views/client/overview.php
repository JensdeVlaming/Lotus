                                ...
                                <div class="row g-0">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <?php if ($item["approved"] != 2 && $item["approved"] != 3 && $item["approved"] != 4) { ?>
                                            ...
                                            <button type="button" class="btn btn-danger col-6" style="z-index: 10" name="deleteButton" data-bs-toggle="modal" data-bs-target="#cancelRequest<?php echo $item["requestId"]; ?>">Annuleren</button>
                                        <?php } ?>
